class HadoopAT265 < Formula
  ...
  url "https://www.apache.org/dyn/closer.lua?path=hadoop/common/hadoop-2.6.5/hadoop-2.6.5.tar.gz"
  #  mirror "https://archive.apache.org/dist/hadoop/common/hadoop-3.2.1/hadoop-3.2.1.tar.gz"
  mirror "https://archive.apache.org/dist/hadoop/common/hadoop-2.6.5/hadoop-2.6.5.tar.gz"
  #  sha256 "f66a3a4115b8f16c1077d1a198a06854dbef0e4233291712ed08d0a10629ed37"
  sha256 "001ad18d4b6d0fe542b15ddadba2d092bc97df1c4d2d797381c8d12887691898"
  revision 1
